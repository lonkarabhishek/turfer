-- PostgreSQL compatible schema for turf booking app
...
-- Functions to update timestamps (PostgreSQL style)
...
CREATE TRIGGER update_turfs_timestamp BEFORE UPDATE ON turfs FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TRIGGER update_games_timestamp BEFORE UPDATE ON games FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
