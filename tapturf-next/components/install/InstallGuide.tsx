    ...
    <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-3xl overflow-hidden shadow-elevated animate-slide-up">
        ...
        <div className="px-6 pt-6 sm:pt-8 pb-6">
          ...
          <h2 className="font-display text-3xl text-primary-800 leading-none tracking-tight mb-4">
          ...
          {canOneTap && (
            <div className="mb-5">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-accent-500 hover:bg-accent-600 text-white font-bold px-4 py-3.5 min-h-[52px] rounded-full transition-colors shadow-neon focus-neon"
              >
          ...
          <div className="rounded-2xl border border-primary-200 bg-primary-50 p-5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-mono text-primary-500 mb-1">
                  Step {step + 1} of {steps.length}
                </p>
                <p className="font-display text-xl text-primary-800 leading-tight">
                  {s.title}
                </p>
          ...
          <div className="flex items-center gap-2">
            ...
            {isLast ? (
              <button
                onClick={onClose}
                className="flex items-center gap-1.5 bg-primary-800 hover:bg-primary-900 text-white font-bold text-[13px] px-5 py-2.5 rounded-full transition-colors shadow-soft focus-neon"
              >
                Got it
              ...
              <button
                onClick={() => setStep(step + 1)}
                className="flex items-center gap-1.5 bg-accent-500 hover:bg-accent-600 text-white font-bold text-[13px] px-5 py-2.5 rounded-full transition-colors shadow-neon focus-neon"
              >
                Next
